...
vs = cv2.VideoCapture(INP_VIDEO_PATH)
writer = None
fps = FPS().start()
...
while True:
    ...
    if OUT_VIDEO_PATH != "" and writer is None:
        # initialize our video writer
        fourcc = cv2.VideoWriter_fourcc(*"MJPG")
        writer = cv2.VideoWriter(OUT_VIDEO_PATH, fourcc, 30, (frame.shape[1], frame.shape[0]), True)
